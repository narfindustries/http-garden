...
METHODS: Final[list[bytes]] = [b'ACL', b'ANNOUNCE', b'BASELINE-CONTROL', b'BIND', b'CHECKIN', b'CHECKOUT', b'COPY', b'DELETE', b'DESCRIBE', b'FLUSH', b'GET', b'GET_PARAMETER', b'LABEL', b'LINK', b'LOCK', b'M-SEARCH', b'MERGE', b'MKACTIVITY', b'MKCALENDAR', b'MKCOL', b'MKREDIRECTREF', b'MKWORKSPACE', b'MOVE', b'NOTIFY', b'ORDERPATCHUPDATEREDIRECTREF', b'PATCH', b'PAUSE', b'PLAY', b'POST', b'PRI', b'PROPFIND', b'PROPPATCH', b'PURGE', b'PUT', b'QUERY', b'REBIND', b'RECORD', b'REDIRECT', b'REFRESH', b'REPORT', b'SEARCH', b'SETUP', b'SET_PARAMETER', b'SOURCE', b'SUBSCRIBE', b'TEARDOWN', b'UNBIND', b'UNCHECKOUT', b'UNKNOWN', b'UNLINK', b'UNLOCK', b'UNSET', b'UNSUBSCRIBE', b'UPDATE', b'VERSION-CONTROL']
